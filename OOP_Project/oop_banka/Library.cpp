...
Loan& Library::createLoan(int loanKeyID, int memberKeyID, int librarianKeyID, const std::string& dateOfLoan)
{
    ...
    this->getLoanManager().addLoan(loanKeyID, member, librarian, dateOfLoan);
