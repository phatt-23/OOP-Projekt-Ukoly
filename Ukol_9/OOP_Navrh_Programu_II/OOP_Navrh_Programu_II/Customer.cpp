...
{
    if (__DEBUG) std::cout << "AbstractCustomer::~AbstractCustomer()" << std::endl;
}
...
{
    if (__DEBUG) std::cout << "AbstractRegisteredCustomer::~AbstractRegisteredCustomer()" << std::endl;
}
...
{
    if (__DEBUG) std::cout << "CompanyUser::~CompanyUser()" << std::endl;
}
...
{
    if (__DEBUG) std::cout << "RegisteredUser::~RegisteredUser()" << std::endl;
}
...
{
    if (__DEBUG) std::cout << "UnregisteredUser::~UnregisteredUser()" << std::endl;
}
